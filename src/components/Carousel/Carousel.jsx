  ...
  return (
    <div className="container py-5">
      <div 
        ...
        className="d-flex justify-content-center align-items-center gap-4 gap-md-5 position-relative"
      >
        <div 
          data-svg-wrapper 
          data-layer="Vector" 
        ...
        >
          ...
          <div data-layer="Rectangle 3" className="carousel-item">
            <img className="carousel-image" src="assets/images/placeholder.png" alt="" />
          </div>
          <div data-layer="Rectangle 4" className="carousel-item">
            <img className="carousel-image" src="assets/images/placeholder.png" alt="" />
          </div>
        </div>
